...
function LandingPage() {
  ...
  const particleWords = useMemo(
    () => [
      `${formatCatalogCount(catalogStats.skillsIndexed)} Skills`,
      `${formatCatalogCount(catalogStats.agentTemplates)} Agents`,
      `${formatCatalogCount(catalogStats.multiAgentSystems)} Multi-Agents`,
    ],
    [catalogStats]
  );
