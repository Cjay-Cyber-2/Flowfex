const AUTH_ERROR_MESSAGES = {
  state_mismatch: 'The social sign-in session expired before Syn-IQ could verify it. Please try again.',
  ...
  invalid_callback_request: 'Syn-IQ could not verify the provider callback. Please try again.',
  ...
  user_creation_failed: 'Syn-IQ could not finish creating the account from the provider response.',
