...
name: superdesign
description: |
  Expert frontend design guidelines for creating beautiful, modern UIs. Use when
  building landing pages, dashboards, or any user interface. Follows a structured
  workflow from ASCII wireframes through theme, animation, and implementation.
license: MIT-0
metadata:
  author: mpociot
  version: "1.0.0"
...
# SuperDesign — Frontend Design Skill
...
2. Theme tokens (colors, fonts, spacing)
3. Animation plan (micro-syntax)
4. Implementation (HTML/CSS or framework code)
